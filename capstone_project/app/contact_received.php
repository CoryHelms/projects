    ...
    <body class="contact-received-body">
        <header>
            ...
            <?php
                ...
                // If user is not logged in, this is the nav bar
                ...
                if (!isset($_SESSION['login_id'])) {
                    ...
                    $checkUserOwner = mysqli_query($conn, "SELECT * FROM PropertyOwner WHERE ((ownerID = '$userID') && (googleID = '$ownGogID'))");
                    $checkUserStudent = mysqli_query($conn, "SELECT * FROM Student WHERE ((studentID = '$userID') && (googleID = '$stuGogID'))");
        ...
        <main>
            ...
            <div class="contact-received-container">
				<h4>
                    Thank you for reaching out, we have received your message and we'll get back to you shortly!
                </h4>
                <h4>
                    Please expect an email or a phone call within 24 hours!
                </h4>
                ...
                if (!isset($_SESSION['login_id'])) {
                    ...
                    <button onclick="location.href=\'../server/googleLogin/login.php\'" type="button"> Return to Home </button>
				    </div>';
