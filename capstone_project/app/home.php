    ...
    <body>
        ...
        <main>
            ...
            <div class="container">
                ...
                <article class="home_highlights">
                    <h2 class="sr-only">Highlights</h2>
                    <!-- A section with a quick link to each individual page on the site. -->
                    <section>
                    ...
                    <section>
                        <a href="../server/instant_messaging/instant_messaging.php">
                            <h2>Chat</h2>
                        </a>
                    </section>
                    <section>
                        <a href="map.php">
                            <h2>View a Map of Apartments</h2>
                        </a>
                    </section>
                    <section>
        ...
        <main>
            ...
            <div class="container">
                ...
                <article class="home_highlights">
                    ...
                    <section>
                        <a href="rating.php">
                            <h2>Rate Roommates or Properties</h2>
                        </a>
                    </section>
                    <section>
                        <a href="roommateHistory.php">
                            <h2>Fill Out a Roommate Request Form</h2>
                        </a>
                    </section>
                    <section>
                        <a href="map.php">
