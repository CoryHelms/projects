        ...
        <main>
            ...
            <div class="center_no_flex">
                ...
                <div class="about_container">
                    ...
                    <div class="text1">
                        <p>
                            Room@IU was created by four IU students who decided to build a website that would be able to match IU students up as roommates based on
                            their personality type. Room@IU also allows Bloomington property owners to showcase their properties to interested students.
                            The creators were motivated by their own personal struggles finding a compatible roommate and realized
                            that many IU students struggle with this as well. Room@IU hopes to get rid of all the stress and anxiety that stems from trying to find the right
                            roommate, as well as the right location.
                        </p>
                    </div>

                    <div class="about_image1">
                        <img src="../server/images/iu_clock.jpg"/>
                    </div>
                </div>
                ...
                <div class="about_container">
                    ...
                    <div class="about_image2">
                        <img src = "../server/images/campus.jpg"/>
                    </div>

                    <div class="text2">
                        <p>
                            Room@IU works by allowing students to receive a score from our Roommate Compatability Questionnaire based on their expectations, preferences,
                            and needs in a roommate! From there, students are able to connect with potential matches with similar scores, as well as Bloomington Property Owners,
                            to find their ideal living situation.
                        </p>
                    </div>
                </div>
            </div>
