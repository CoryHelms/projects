The purpose of this file was to create a twitter bot that would tweet thank you message to donors when donating during a live event hosted by the Terre Haute Symphony Orchestra in Terre Haute, Indiana.
